...
from tai_kit.net.url_guard import UrlGuardError
...
async def url_to_filelike(
    ...
    The default path (no ``client``) fetches through :func:`tai_kit.net.fetch_url`
    ...
    :class:`~tai_kit.net.url_guard.UrlGuardError`), then the body is streamed on
